...
(define-abbrev-table 'c-mode-abbrev-table
  '(
    ("case" "" mg-skel-c-case 8)
    ("do" "" mg-skel-c-do 1)
    ("else" "" mg-skel-c-else 10)
    ("for" "" mg-skel-c-for 22)
    ("if" "" mg-skel-c-if 27)
    ("switch" "" mg-skel-c-switch 1)
    ("while" "" mg-skel-c-while 5)
   ))
...
(define-abbrev-table 'cperl-mode-abbrev-table
  '(
    ...
    ("else" "else" cperl-electric-else 5)
    ("elsif" "elsif" cperl-electric-keyword 0)
    ("for" "for" cperl-electric-keyword 1)
    ("foreach" "foreach" cperl-electric-keyword 2)
    ("if" "if" cperl-electric-keyword 12)
    ("unless" "unless" cperl-electric-keyword 1)
    ("until" "until" cperl-electric-keyword 0)
    ("while" "while" cperl-electric-keyword 3)
   ))
...
(define-abbrev-table 'html3-mode-abbrev-table '())
