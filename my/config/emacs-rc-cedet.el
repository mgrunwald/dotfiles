...
(setq damian-dsp-project
      (ede-cpp-root-project "damian-dsp"
                            :file "~/projects/damian/trunk/DSP/pt/measurement_core/main.c"
                            :local-variables (list
...
(setq damian-loaddsp-project
      (ede-cpp-root-project "damian-loaddsp"
                            :file "~/projects/damian/trunk/DSP/pt/tools/loaddsp/arm_main.c"
                            :local-variables (list
                                              (cons 'compile-command
                                                    'mg/gen-std-compile-string )
                                              )
...
(setq damian-loader-project
      (ede-cpp-root-project "damian-loader"
                            :file "~/projects/damian/trunk/DSP/pt/tools/loader/loader.c"
                            :local-variables (list
                                              (cons 'compile-command
                                                    'mg/gen-std-compile-string )
                                              )
...
(setq damian-firmware-project
      (ede-cpp-root-project "damian-firmware-project"
                            :file "~/projects/damian/trunk/MPC/firmware/DAMIAN.pro"
                            :local-variables (list
                                              (cons 'compile-command
                                                    'mg/gen-std-compile-string
                                                    )
