...
;; Move by paragraph
(global-set-key (kbd "M-U") '(lambda () (interactive) (scroll-down 1) ) ) ; was none
(global-set-key (kbd "M-O") '(lambda () (interactive) (scroll-up 1) ) ) ; was none

;; Move to beginning/ending of line
(global-set-key (kbd "M-h") 'mg-home) ; was mark-paragraph
...
(global-set-key (kbd "M-D") 'redo) ;

; Kill line
(global-set-key (kbd "M-f") 'mg-kill-entire-line) ; was forward-word
...
(global-set-key (kbd "M-1") 'kill-this-buffer) ; was digit-argument
(global-set-key (kbd "M-0") 'ska-kill-this-window) ; was digit-argument
...
(provide 'ergonomic_keybinding_qwerty)
