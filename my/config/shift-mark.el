...
(defun shift-mark-eol ()
  (interactive)
  (shift-mark 'home-end-end)
)

(defun shift-mark-home ()
  (interactive)
  (shift-mark 'home-end-home)
)
...
(global-set-key '[(shift home)]    'shift-mark-home)
(global-set-key '[(shift end)]    'shift-mark-eol)
